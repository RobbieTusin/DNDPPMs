			...
			<?php 
				...
				if(isset($_GET['expense_id']))
				{
				  ...
				  $updated=mysql_query("UPDATE expenses SET expense_code='$expense_code', expense_category='$expense_category' WHERE expense_id='$expense_id'")or die();
				  if($updated)
				  {
			...
			<?php 
				if(isset($_GET['expense_id']))
				{
					...
					$getselect=mysql_query("SELECT * FROM expenses WHERE expense_id='$expense_id'");
					while($profile=mysql_fetch_array($getselect))
				{

					$expense_code=$profile['expense_code'];
					$expense_category=$profile['expense_category'];	
...
<head>
  ...
  <title>DND PBAC PPMS | Procurement Edit Form </title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Expenses details Edit Form</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><B>Expenses details Edit Form</B></h3>
        </div>
        ...
        <div class="box-body">
										 ...
										 <div class="form-group">
                                            <label for="name"  id="preinput"> <b> Expense code : </b> </label>
											<input type="text" name="expense_code" required placeholder="Expense Code" 
											value="<?php echo $expense_code ?>" id="inputid" class="form-control"/>
                                        </div>		
										<div class="form-group">
											<label for="name"  id="preinput"> <b> Expense Category  : </b> </label>
											<input type="text" name="expense_category" required placeholder="Expense Category" 
											value="<?php echo $expense_category; ?>" id="inputid" class="form-control"/>
                                        </div>
