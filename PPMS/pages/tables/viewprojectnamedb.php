...
<?php
 include('db.php');
  $select=mysql_query("SELECT * FROM projectname order by projectid desc");
  $i=1;
...
<table border=1>
  <tr>	
		<td width=300 ><?php echo $projectid; ?>
		...
		<td width=100><a href="deleteprojectnamedb.php?projectid=<?php echo $projectid; ?>" onclick="return confirm('Are you sure you want to delete this Record?');">
    	<span class="delete" title="Delete">delete </span></a>	
		<td width=100><a href="edit.php?projectid=<?php echo $projectid; ?>"><span class="edit" title="Edit">edit</span></a>	
  </tr>
</table> 
</div>
