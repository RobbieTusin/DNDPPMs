...
<head>
  ...
  <title>DND PBAC PPMS | Data Tables</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><b>Expense List View </b></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Expense List View<b></b></h3>
			  <br>			
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
					<tr>
						<th> <center> EXPENSE CODE 		</center>	</th>
						<th> <center> EXPENSE CLASS		</center>	</th>
				...
				{					
					...
					$select=mysql_query("SELECT * FROM expenses WHERE expense_code LIKE '%$searchtext%' or expense_category LIKE 
					'%$searchtext%' order by expense_id desc");
					$i=1;
				}
				else
				{		
					$select=mysql_query("SELECT * FROM expenses order by expense_id desc");
					$i=1;
				}
				while($userrow=mysql_fetch_array($select))
				{
					$expense_id =$userrow['expense_id'];
					$expense_code =$userrow['expense_code'];
					$expenseclass =$userrow['expenseclass'];
					 
					?>
                				
					<tr>	
						<td width=300 ><?php echo $expense_code; ?>
						<td width=300 ><?php echo $expenseclass; ?>
						<td width=100>
							<span class="delete" title="Delete">
								<center>
									<button data-toggle="modal" data-target="#ModalDelete<?php echo $userrow['expense_id'] ?>" type="button" class="btn bg-olive margin"><i class="fa fa-trash-o fa-fw"></i></button>
								</center> 
							</span>
						</td>	
						<td width=100>
							<a href="editexpenses.html?expense_id=<?php echo $expense_id; ?>">
								<span class="edit" title="Edit">
									<center>
										<button type="button" class="btn bg-purple margin"><i class="fa  fa-edit fa-fw"></i></button>
									</center>
								</span>
							</a>	
						</td>	
						...
						<!------------------------------------------ Modal ----------------------------------------------------------------------->
		<div class="modal fade" id="ModalDelete<?php echo $userrow['expense_id'] ?>" tabindex="-1" role="dialog"aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header col-md-12">
						...
						<div class="form-group">
							<label class="col-md-12 form-group">Are you sure you want to Delete?</label>
						</div>  
					...
					<div class="modal-footer">
						...
						<a href="deleteexpensesdb.php?expense_id=<?php echo $userrow['expense_id']; ?>">
							<button type="submit" value="Upload" class="btn btn-primary" >Confirm<i class="glyphicon glyphicon-ok"> </i></button>
						</a>
					</div>
				</div>
			</div>
...
<!------------------------------------------ EDIT --------------------------------------------------------------------->		
					...
					?>
						...
						<a href="../tables/expensesform.php"><button type="button" class="btn bg-red margin pull-right">BACK</button></a>
